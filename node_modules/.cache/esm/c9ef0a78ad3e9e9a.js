let FAQS,GLOBALS,REVIEWS,TRUSTEES,remove_image,remove_video,save_image,save_video;_ad3‍.x([["GLOBALS_about_statement",()=>GLOBALS_about_statement],["GLOBALS_verified_reviews",()=>GLOBALS_verified_reviews],["GLOBAL_user_review",()=>GLOBAL_user_review],["reviews",()=>reviews],["faqs",()=>faqs],["new_faq",()=>new_faq],["remove_faq",()=>remove_faq],["update_faq",()=>update_faq],["new_review",()=>new_review],["remove_review",()=>remove_review],["trusted_by",()=>trusted_by],["add_trusted_by",()=>add_trusted_by],["remove_trustee",()=>remove_trustee],["approve_review",()=>approve_review],["user_review",()=>user_review],["update_user_review",()=>update_user_review],["about_statement",()=>about_statement],["post_about_statement",()=>post_about_statement]]);_ad3‍.w("../ds/conn",[["FAQS",["FAQS"],function(v){FAQS=v}],["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["REVIEWS",["REVIEWS"],function(v){REVIEWS=v}],["TRUSTEES",["TRUSTEES"],function(v){TRUSTEES=v}]]);_ad3‍.w("./utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["remove_video",["remove_video"],function(v){remove_video=v}],["save_image",["save_image"],function(v){save_image=v}],["save_video",["save_video"],function(v){save_video=v}]]);
