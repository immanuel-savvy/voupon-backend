let axios,TRANSACTIONS,USERS,VENDORS,WALLETS,paystack_secret_key,voucher_redeemed_email,send_mail,Paystack_private_key;_f32‍.x([["transactions",()=>transactions],["get_banks",()=>get_banks],["withdraw_wallet",()=>withdraw_wallet]]);_f32‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_f32‍.w("../ds/conn",[["TRANSACTIONS",["TRANSACTIONS"],function(v){TRANSACTIONS=v}],["USERS",["USERS"],function(v){USERS=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}],["WALLETS",["WALLETS"],function(v){WALLETS=v}]]);_f32‍.w("./admin",[["paystack_secret_key",["paystack_secret_key"],function(v){paystack_secret_key=v}]]);_f32‍.w("./emails",[["voucher_redeemed_email",["voucher_redeemed_email"],function(v){voucher_redeemed_email=v}]]);_f32‍.w("./users",[["send_mail",["send_mail"],function(v){send_mail=v}]]);_f32‍.w("./utils",[["Paystack_private_key",["Paystack_private_key"],function(v){Paystack_private_key=v}]]);
  ...
  axios({
    ...
    .then((result) => {
      ...
      axios({
        ...
        .catch((err) => _f32‍.g.console.log(err, "HERE"));
    })
    .catch((err) => _f32‍.g.console.log(err, "H#$#"));
};
