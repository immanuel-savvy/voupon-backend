let axios,_id,OFFER_VOUCHERS,OPEN_VOUCHERS,PURCHASED_VOUCHERS,REDEEMED_VOUCHERS,TRANSACTIONS,USERS,USER_VOUCHERS,VENDORS,VOUCHERS,WALLETS,generate_random_string,shuffle_array,paystack_secret_key,voucher_otp_email,voucher_purchased_email,voucher_redeemed_email,default_wallet,send_mail,save_image,rewards;_21c‍.x([["get_offer_vouchers",()=>get_offer_vouchers],["create_offer_voucher",()=>create_offer_voucher],["create_open_voucher",()=>create_open_voucher],["offer_vouchers",()=>offer_vouchers],["verify_voucher",()=>verify_voucher],["voucher_page",()=>voucher_page],["open_vouchers",()=>open_vouchers],["update_voucher",()=>update_voucher],["voucher_purchased",()=>voucher_purchased],["user_vouchers",()=>user_vouchers],["redeem_voucher",()=>redeem_voucher],["can_redeem_voucher",()=>can_redeem_voucher],["request_voucher_otp",()=>request_voucher_otp],["transfer_voucher",()=>transfer_voucher],["remove_from_closed_voucher",()=>remove_from_closed_voucher],["close_voucher",()=>close_voucher],["parse_vendor_id",()=>parse_vendor_id],["reset_vendor_id",()=>reset_vendor_id],["use_voucher",()=>use_voucher],["vendor_id",()=>vendor_id],["generate_voucher_otp",()=>generate_voucher_otp],["unmask_id",()=>unmask_id],["mask_id",()=>mask_id]]);_21c‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_21c‍.w("generalised-datastore/utils/functions",[["_id",["_id"],function(v){_id=v}]]);_21c‍.w("../ds/conn",[["OFFER_VOUCHERS",["OFFER_VOUCHERS"],function(v){OFFER_VOUCHERS=v}],["OPEN_VOUCHERS",["OPEN_VOUCHERS"],function(v){OPEN_VOUCHERS=v}],["PURCHASED_VOUCHERS",["PURCHASED_VOUCHERS"],function(v){PURCHASED_VOUCHERS=v}],["REDEEMED_VOUCHERS",["REDEEMED_VOUCHERS"],function(v){REDEEMED_VOUCHERS=v}],["TRANSACTIONS",["TRANSACTIONS"],function(v){TRANSACTIONS=v}],["USERS",["USERS"],function(v){USERS=v}],["USER_VOUCHERS",["USER_VOUCHERS"],function(v){USER_VOUCHERS=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}],["VOUCHERS",["VOUCHERS"],function(v){VOUCHERS=v}],["WALLETS",["WALLETS"],function(v){WALLETS=v}]]);_21c‍.w("../functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}],["shuffle_array",["shuffle_array"],function(v){shuffle_array=v}]]);_21c‍.w("./admin",[["paystack_secret_key",["paystack_secret_key"],function(v){paystack_secret_key=v}]]);_21c‍.w("./emails",[["voucher_otp_email",["voucher_otp_email"],function(v){voucher_otp_email=v}],["voucher_purchased_email",["voucher_purchased_email"],function(v){voucher_purchased_email=v}],["voucher_redeemed_email",["voucher_redeemed_email"],function(v){voucher_redeemed_email=v}]]);_21c‍.w("./starter",[["default_wallet",["default_wallet"],function(v){default_wallet=v}]]);_21c‍.w("./users",[["send_mail",["send_mail"],function(v){send_mail=v}]]);_21c‍.w("./utils",[["save_image",["save_image"],function(v){save_image=v}]]);_21c‍.w("./wallets",[["rewards",["rewards"],function(v){rewards=v}]]);
...
const vendor_id = (req, res) => {
  ...
  let user = _21c‍.a("USERS",USERS).readone({ email });
  if (!user)
  ...
  let vendor = _21c‍.a("VENDORS",VENDORS).readone(user.vendor);
...
const create_offer_voucher = (req, res) => {
  ...
  voucher.images = voucher.images.map((img) => {
    img.url = _21c‍.a("save_image",save_image)(img.url);

    return img;
  });
  let result = _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).write(voucher);
  voucher._id = result._id;
  voucher.created = result.created;

  _21c‍.a("VENDORS",VENDORS).update(voucher.vendor, { vouchers: { $inc: 1 } });
...
const offer_vouchers = (req, res) => {
  ...
  res.json({
    ok: true,
    message: "vouchers",
    data: _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).read({ vendor }),
  });
};
...
const open_vouchers = (req, res) => {
  ...
  res.json({
    ok: true,
    message: "vouchers",
    data: _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS).read({ user }),
  });
};
...
const get_offer_vouchers = (req, res) => {
  ...
  let vendors = _21c‍.a("VENDORS",VENDORS).read();
  ...
  _21c‍.a("shuffle_array",shuffle_array)(vouchers);
  ...
  res.json({
    ...
    data: { vendors: n, vouchers, total: _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).config.total_entries },
  });
};
...
const voucher_purchased = (req, res) => {
  ...
  let voucher_code = _21c‍.a("generate_random_string",generate_random_string)(6, "alpha").toUpperCase();
  while (_21c‍.a("PURCHASED_VOUCHERS",PURCHASED_VOUCHERS).readone({ voucher_code }))
    voucher_code = _21c‍.a("generate_random_string",generate_random_string)(6, "alpha").toUpperCase();

  let vendor = _21c‍.a("VENDORS",VENDORS).readone(details.vendor);
  if (vendor.suspended)
    return res.json({
      ok: false,
  ...
  let result = _21c‍.a("PURCHASED_VOUCHERS",PURCHASED_VOUCHERS).write({
    ...details,
    voucher_code,
  });

  let offer_voucher = _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).update(
  ...
  let voucher = _21c‍.a("VOUCHERS",VOUCHERS).write(offer_voucher);
  details.voucher = voucher._id;

  _21c‍.a("USER_VOUCHERS",USER_VOUCHERS).write({
  ...
  _21c‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);

  _21c‍.a("send_mail",send_mail)({
    recipient: details.email,
    recipient_name: `${details.firstname} ${details.lastname}`,
    subject: "[Voucher Africa] Voucher Purchased",
    html: _21c‍.a("voucher_purchased_email",voucher_purchased_email)({ ...details, voucher_code }),
  });
  ...
  _21c‍.a("send_mail",send_mail)({
    ...
    html: _21c‍.a("voucher_purchased_email",voucher_purchased_email)({ ...details, ...vendor, voucher_code }),
  });
...
const voucher_creation_fees = (details) => {
  let user = _21c‍.a("USERS",USERS).readone(details.user);
  let fee = user.premium ? 50 : 100;
  _21c‍.a("WALLETS",WALLETS).update(_21c‍.a("default_wallet",default_wallet), {
    total_earning: { $inc: fee },
    balance: { $inc: fee },
  });

  _21c‍.a("TRANSACTIONS",TRANSACTIONS).write({
  ...
  if (user.referral) {
    let ref_fee = fee * 0.1;
    let ref = _21c‍.a("USERS",USERS).readone(user._id);
    _21c‍.a("WALLETS",WALLETS).update(ref.wallet, { balance: { $inc: ref_fee } });
    _21c‍.a("TRANSACTIONS",TRANSACTIONS).write({
      wallet: ref.wallet,
      value: ref_fee,
      type: "voucher",
...
const create_open_voucher = (req, res) => {
  ...
  let result = _21c‍.a("VOUCHERS",VOUCHERS).write(details);
  details._id = result._id;
  details.created = result.created;

  result = _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS).write({
    voucher: details._id,
    user: details.user,
    value: details.value,
    voucher_code,
...
const user_vouchers = (req, res) => {
  ...
  let open_vouchers = _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS).read({ user }),
    offer_vouchers = _21c‍.a("USER_VOUCHERS",USER_VOUCHERS).read({ user });
...
const can_redeem_voucher = (
  ...
  if (!user && email) {
    user = _21c‍.a("USERS",USERS).readone({ email });
    if (!user)
  ...
  let voucher = (
    voucher_type === "offer_voucher" ? _21c‍.a("USER_VOUCHERS",USER_VOUCHERS) : _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS)
...
const redeem_voucher = (req, res) => {
  ...
  voucher = (
    voucher_type === "open_voucher" ? _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS) : _21c‍.a("USER_VOUCHERS",USER_VOUCHERS)
  ...
  let reference = _21c‍.a("generate_random_string",generate_random_string)(20, "alnum");

  let { _id } = voucher;
  let user_ = _21c‍.a("USERS",USERS).readone(user);
  ...
  if (!email) {
    email = _21c‍.a("USERS",USERS).readone(user);
  ...
  _21c‍.a("axios",axios)({
    ...
    method: "post",
    headers: {
      Authorization: `Bearer ${_21c‍.a("paystack_secret_key",paystack_secret_key)}`,
    ...
    .then((result) => {
      ...
      _21c‍.a("axios",axios)({
        ...
        data: {
          source: "balance",
          amount: value - _21c‍.a("rewards",rewards).voucher_redeemed_fee,
          recipient,
        },
      })
        .then((result) => {
          ...
          if (voucher_type === "open_voucher")
            _21c‍.a("VOUCHERS",VOUCHERS).update(voucher._id, { redeemed: true, state: "redeemed" });

          (voucher_type === "offer_voucher"
            ? _21c‍.a("USER_VOUCHERS",USER_VOUCHERS)
            : _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS)
          ).update({ user, _id }, { state: "redeemed" });

          _21c‍.a("REDEEMED_VOUCHERS",REDEEMED_VOUCHERS).write({
            voucher: voucher._id,
            transfer_details: {
              recipient,
          ...
          let tx = {
            ...
            value: value - _21c‍.a("rewards",rewards).voucher_redeemed_fee,
            wallet: _21c‍.a("USERS",USERS).readone(user).wallet,
          };

          _21c‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);

          let tx_fee = _21c‍.a("rewards",rewards).voucher_redeemed_fee;
          if (referral) {
            referral = _21c‍.a("USERS",USERS).readone(referral);
          ...
          if (referral) {
            let ref_fee = _21c‍.a("rewards",rewards).voucher_redeemed_fee - tx_fee;
            _21c‍.a("WALLETS",WALLETS).update(referral.wallet, {
              balance: { $inc: ref_fee },
          ...
          _21c‍.a("send_mail",send_mail)({
            ...
            html: _21c‍.a("voucher_redeemed_email",voucher_redeemed_email)({ ...details, voucher_code }),
          });
        ...
        .catch((err) => _21c‍.g.console.log(err, "HERE"));
    })
    .catch((err) => _21c‍.g.console.log(err, "H#$#"));
};
...
const request_voucher_otp = (req, res) => {
  ...
  } else if (!email && user) email = _21c‍.a("USERS",USERS).readone(user).email;

  let code = _21c‍.a("generate_random_string",generate_random_string)(6, "num");
  let voucher = (
    voucher_type === "open_voucher" ? _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS) : _21c‍.a("USER_VOUCHERS",USER_VOUCHERS)
  ).readone({ user, voucher_code });
  ...
  let { _id } = voucher;
  let { firstname, lastname } = _21c‍.a("USERS",USERS).readone(user);
  ...
  _21c‍.a("send_mail",send_mail)({
    ...
    html: _21c‍.a("voucher_otp_email",voucher_otp_email)({ ...voucher, code }),
  });
...
const transfer_voucher = (req, res) => {
  ...
  voucher_type === "open_voucher" &&
    _21c‍.a("VOUCHERS",VOUCHERS).update(user_voucher.voucher, { email: email2, user });
...
const verify_voucher = (req, res) => {
  ...
  user = user || _21c‍.a("USERS",USERS).readone({ email: email.toLowerCase() });
  ...
  res.json({
    ...
    data: voucher
      ? {
          ...
          voucher: { ...voucher, user: _21c‍.a("USERS",USERS).readone(voucher.user) },
          _id: voucher._id,
        }
...
const close_voucher = (req, res) => {
  ...
  let result = _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).update(
    { _id: voucher, vendor },
...
const remove_from_closed_voucher = (req, res) => {
  ...
  _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).update(
    { _id: voucher, vendor },
...
const use_voucher = (req, res) => {
  ...
  voucher = (
    voucher.startsWith("user") ? _21c‍.a("USER_VOUCHERS",USER_VOUCHERS) : _21c‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS)
  ).readone({ _id: voucher, user });

  vendor = _21c‍.a("VENDORS",VENDORS).readone(vendor);

  value = Number(voucher.voucher.vendor ? Number(voucher.value) : value);

  let vendor_value = value - value * 0.05;
  _21c‍.a("WALLETS",WALLETS).update(vendor.wallet, { vouchers: { $inc: vendor_value } });
  ...
  _21c‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);
  tx.value = value;
  tx.wallet = _21c‍.a("USERS",USERS).readone(user).wallet;
  tx.credit = false;
  _21c‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);
  ...
  if (voucher.voucher.vendor) {
    _21c‍.a("USER_VOUCHERS",USER_VOUCHERS).update({ user, _id: voucher._id }, { state: "used" });

    _21c‍.a("VOUCHERS",VOUCHERS).update(voucher.voucher._id, { state: "used" });
  } else {
    _21c‍.a("VOUCHERS",VOUCHERS).update(voucher.voucher._id, { value: { $dec: value } });
  }

  res.json({
    ok: true,
    data: { success: true, voucher, vendor, user: _21c‍.a("USERS",USERS).readone(user) },
  });
};
...
const voucher_page = (req, res) => {
  ...
  voucher = _21c‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).readone({ _id: voucher, vendor });
  vendor = voucher && vendor && _21c‍.a("VENDORS",VENDORS).readone(vendor);
...
;_21c‍.j(["get_offer_vouchers","create_offer_voucher","create_open_voucher","offer_vouchers","verify_voucher","voucher_page","open_vouchers","update_voucher","voucher_purchased","user_vouchers","redeem_voucher","can_redeem_voucher","request_voucher_otp","transfer_voucher","remove_from_closed_voucher","close_voucher","parse_vendor_id","reset_vendor_id","use_voucher","vendor_id","generate_voucher_otp","unmask_id","mask_id"]);
