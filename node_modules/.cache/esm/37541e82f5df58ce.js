let generate_random_string,EVENTS,EVENT_TICKETS,TICKETS,TRANSACTIONS,USERS,USER_TICKETS,VENDORS,VENDOR_EVENTS,WALLETS,voucher_otp_email,voucher_purchased_email,default_wallet,send_mail,save_image,reset_vendor_id;_f5d‍.x([["create_event",()=>create_event],["upcoming_events",()=>upcoming_events],["request_ticket_otp",()=>request_ticket_otp],["vendor_events",()=>vendor_events],["events",()=>events],["ticket_purchased",()=>ticket_purchased],["event_tickets",()=>event_tickets],["use_ticket",()=>use_ticket],["verify_ticket",()=>verify_ticket],["can_transact_ticket",()=>can_transact_ticket],["user_tickets",()=>user_tickets],["update_event",()=>update_event]]);_f5d‍.w("generalised-datastore/utils/functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}]]);_f5d‍.w("../ds/conn",[["EVENTS",["EVENTS"],function(v){EVENTS=v}],["EVENT_TICKETS",["EVENT_TICKETS"],function(v){EVENT_TICKETS=v}],["TICKETS",["TICKETS"],function(v){TICKETS=v}],["TRANSACTIONS",["TRANSACTIONS"],function(v){TRANSACTIONS=v}],["USERS",["USERS"],function(v){USERS=v}],["USER_TICKETS",["USER_TICKETS"],function(v){USER_TICKETS=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}],["VENDOR_EVENTS",["VENDOR_EVENTS"],function(v){VENDOR_EVENTS=v}],["WALLETS",["WALLETS"],function(v){WALLETS=v}]]);_f5d‍.w("./emails",[["voucher_otp_email",["voucher_otp_email"],function(v){voucher_otp_email=v}],["voucher_purchased_email",["voucher_purchased_email"],function(v){voucher_purchased_email=v}]]);_f5d‍.w("./starter",[["default_wallet",["default_wallet"],function(v){default_wallet=v}]]);_f5d‍.w("./users",[["send_mail",["send_mail"],function(v){send_mail=v}]]);_f5d‍.w("./utils",[["save_image",["save_image"],function(v){save_image=v}]]);_f5d‍.w("./voucher",[["reset_vendor_id",["reset_vendor_id"],function(v){reset_vendor_id=v}]]);
...
const verify_ticket = (req, res) => {
  ...
  _f5d‍.g.console.log(user_ticket);
  let ticket = TICKETS.readone(user_ticket.ticket);
  _f5d‍.g.console.log(ticket);
