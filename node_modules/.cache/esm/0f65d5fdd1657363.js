let axios,_id,OFFER_VOUCHERS,OPEN_VOUCHERS,PURCHASED_VOUCHERS,REDEEMED_VOUCHERS,TRANSACTIONS,USERS,USER_VOUCHERS,VENDORS,VOUCHERS,WALLETS,generate_random_string,shuffle_array,paystack_secret_key,voucher_otp_email,voucher_purchased_email,voucher_redeemed_email,send_mail,save_image,save_video;_d16‍.x([["get_offer_vouchers",()=>get_offer_vouchers],["create_offer_voucher",()=>create_offer_voucher],["create_open_voucher",()=>create_open_voucher],["offer_vouchers",()=>offer_vouchers],["verify_voucher",()=>verify_voucher],["open_vouchers",()=>open_vouchers],["voucher_purchased",()=>voucher_purchased],["user_vouchers",()=>user_vouchers],["redeem_voucher",()=>redeem_voucher],["can_redeem_voucher",()=>can_redeem_voucher],["request_voucher_otp",()=>request_voucher_otp],["transfer_voucher",()=>transfer_voucher],["close_voucher",()=>close_voucher],["parse_vendor_id",()=>parse_vendor_id],["reset_vendor_id",()=>reset_vendor_id],["use_voucher",()=>use_voucher],["vendor_id",()=>vendor_id],["generate_voucher_otp",()=>generate_voucher_otp]]);_d16‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_d16‍.w("generalised-datastore/utils/functions",[["_id",["_id"],function(v){_id=v}]]);_d16‍.w("../ds/conn",[["OFFER_VOUCHERS",["OFFER_VOUCHERS"],function(v){OFFER_VOUCHERS=v}],["OPEN_VOUCHERS",["OPEN_VOUCHERS"],function(v){OPEN_VOUCHERS=v}],["PURCHASED_VOUCHERS",["PURCHASED_VOUCHERS"],function(v){PURCHASED_VOUCHERS=v}],["REDEEMED_VOUCHERS",["REDEEMED_VOUCHERS"],function(v){REDEEMED_VOUCHERS=v}],["TRANSACTIONS",["TRANSACTIONS"],function(v){TRANSACTIONS=v}],["USERS",["USERS"],function(v){USERS=v}],["USER_VOUCHERS",["USER_VOUCHERS"],function(v){USER_VOUCHERS=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}],["VOUCHERS",["VOUCHERS"],function(v){VOUCHERS=v}],["WALLETS",["WALLETS"],function(v){WALLETS=v}]]);_d16‍.w("../functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}],["shuffle_array",["shuffle_array"],function(v){shuffle_array=v}]]);_d16‍.w("./admin",[["paystack_secret_key",["paystack_secret_key"],function(v){paystack_secret_key=v}]]);_d16‍.w("./emails",[["voucher_otp_email",["voucher_otp_email"],function(v){voucher_otp_email=v}],["voucher_purchased_email",["voucher_purchased_email"],function(v){voucher_purchased_email=v}],["voucher_redeemed_email",["voucher_redeemed_email"],function(v){voucher_redeemed_email=v}]]);_d16‍.w("./users",[["send_mail",["send_mail"],function(v){send_mail=v}]]);_d16‍.w("./utils",[["save_image",["save_image"],function(v){save_image=v}],["save_video",["save_video"],function(v){save_video=v}]]);
  ...
  axios({
    ...
    .then((result) => {
      ...
      axios({
        ...
        .catch((err) => _d16‍.g.console.log(err, "HERE"));
    })
    .catch((err) => _d16‍.g.console.log(err, "H#$#"));
};
