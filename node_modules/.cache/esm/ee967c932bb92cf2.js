let USERS,USERS_HASH,nodemailer,generate_random_string,verification,remove_image,save_image;_2bb‍.x([["signup",()=>signup],["login",()=>login],["user_by_email",()=>user_by_email],["user",()=>user],["send_mail",()=>send_mail],["verify_email",()=>verify_email],["to_title",()=>to_title],["update_user",()=>update_user]]);_2bb‍.w("../ds/conn",[["USERS",["USERS"],function(v){USERS=v}],["USERS_HASH",["USERS_HASH"],function(v){USERS_HASH=v}]]);_2bb‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_2bb‍.w("generalised-datastore/utils/functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}]]);_2bb‍.w("./emails",[["verification",["verification"],function(v){verification=v}]]);_2bb‍.w("./utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["save_image",["save_image"],function(v){save_image=v}]]);
...
const send_mail = ({
  ...
  try {
    ...
    _2bb‍.g.console.log("in here with", recipient);
  } catch (e) {}
  ...
  try {
    transporter
      ...
      .then((res) => {})
      .catch((e) => _2bb‍.g.console.log(e));
    _2bb‍.g.console.log("Email sent", recipient);
  } catch (e) {}
};
