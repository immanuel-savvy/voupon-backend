let COUPONS,EVENTS,FAQS,GLOBALS,OFFER_VOUCHERS,REVIEWS,TRUSTEES,VENDORS,remove_image,remove_video,save_image,save_video;_c6f‍.x([["GLOBALS_about_statement",()=>GLOBALS_about_statement],["GLOBALS_verified_reviews",()=>GLOBALS_verified_reviews],["GLOBAL_user_review",()=>GLOBAL_user_review],["reviews",()=>reviews],["faqs",()=>faqs],["search_query",()=>search_query],["new_faq",()=>new_faq],["remove_faq",()=>remove_faq],["update_faq",()=>update_faq],["new_review",()=>new_review],["remove_review",()=>remove_review],["trusted_by",()=>trusted_by],["add_trusted_by",()=>add_trusted_by],["remove_trustee",()=>remove_trustee],["approve_review",()=>approve_review],["user_review",()=>user_review],["update_user_review",()=>update_user_review],["about_statement",()=>about_statement],["post_about_statement",()=>post_about_statement]]);_c6f‍.w("../ds/conn",[["COUPONS",["COUPONS"],function(v){COUPONS=v}],["EVENTS",["EVENTS"],function(v){EVENTS=v}],["FAQS",["FAQS"],function(v){FAQS=v}],["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["OFFER_VOUCHERS",["OFFER_VOUCHERS"],function(v){OFFER_VOUCHERS=v}],["REVIEWS",["REVIEWS"],function(v){REVIEWS=v}],["TRUSTEES",["TRUSTEES"],function(v){TRUSTEES=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}]]);_c6f‍.w("./utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["remove_video",["remove_video"],function(v){remove_video=v}],["save_image",["save_image"],function(v){save_image=v}],["save_video",["save_video"],function(v){save_video=v}]]);
