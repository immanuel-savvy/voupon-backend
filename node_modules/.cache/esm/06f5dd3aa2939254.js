let GLOBALS,NOTIFICATIONS,SUBCRIPTIONS,TRANSACTIONS,USERS,VENDORS,WALLETS,GLOBAL_subscriptions,default_user;_a29‍.x([["refresh_subscriptions",()=>refresh_subscriptions]]);_a29‍.w("../ds/conn",[["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["NOTIFICATIONS",["NOTIFICATIONS"],function(v){NOTIFICATIONS=v}],["SUBCRIPTIONS",["SUBCRIPTIONS"],function(v){SUBCRIPTIONS=v}],["TRANSACTIONS",["TRANSACTIONS"],function(v){TRANSACTIONS=v}],["USERS",["USERS"],function(v){USERS=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}],["WALLETS",["WALLETS"],function(v){WALLETS=v}]]);_a29‍.w("./marketplace",[["GLOBAL_subscriptions",["GLOBAL_subscriptions"],function(v){GLOBAL_subscriptions=v}]]);_a29‍.w("./starter",[["default_user",["default_user"],function(v){default_user=v}]]);
