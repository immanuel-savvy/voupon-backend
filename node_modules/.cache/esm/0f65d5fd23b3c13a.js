let axios,_id,OFFER_VOUCHERS,OPEN_VOUCHERS,PURCHASED_VOUCHERS,REDEEMED_VOUCHERS,TRANSACTIONS,USERS,USER_VOUCHERS,VENDORS,VOUCHERS,WALLETS,generate_random_string,shuffle_array,paystack_secret_key,voucher_otp_email,voucher_purchased_email,voucher_redeemed_email,default_wallet,send_mail,save_image,rewards;_23b‍.x([["get_offer_vouchers",()=>get_offer_vouchers],["create_offer_voucher",()=>create_offer_voucher],["create_open_voucher",()=>create_open_voucher],["offer_vouchers",()=>offer_vouchers],["verify_voucher",()=>verify_voucher],["open_vouchers",()=>open_vouchers],["update_voucher",()=>update_voucher],["voucher_purchased",()=>voucher_purchased],["user_vouchers",()=>user_vouchers],["redeem_voucher",()=>redeem_voucher],["can_redeem_voucher",()=>can_redeem_voucher],["request_voucher_otp",()=>request_voucher_otp],["transfer_voucher",()=>transfer_voucher],["close_voucher",()=>close_voucher],["parse_vendor_id",()=>parse_vendor_id],["reset_vendor_id",()=>reset_vendor_id],["use_voucher",()=>use_voucher],["vendor_id",()=>vendor_id],["generate_voucher_otp",()=>generate_voucher_otp],["unmask_id",()=>unmask_id],["mask_id",()=>mask_id]]);_23b‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_23b‍.w("generalised-datastore/utils/functions",[["_id",["_id"],function(v){_id=v}]]);_23b‍.w("../ds/conn",[["OFFER_VOUCHERS",["OFFER_VOUCHERS"],function(v){OFFER_VOUCHERS=v}],["OPEN_VOUCHERS",["OPEN_VOUCHERS"],function(v){OPEN_VOUCHERS=v}],["PURCHASED_VOUCHERS",["PURCHASED_VOUCHERS"],function(v){PURCHASED_VOUCHERS=v}],["REDEEMED_VOUCHERS",["REDEEMED_VOUCHERS"],function(v){REDEEMED_VOUCHERS=v}],["TRANSACTIONS",["TRANSACTIONS"],function(v){TRANSACTIONS=v}],["USERS",["USERS"],function(v){USERS=v}],["USER_VOUCHERS",["USER_VOUCHERS"],function(v){USER_VOUCHERS=v}],["VENDORS",["VENDORS"],function(v){VENDORS=v}],["VOUCHERS",["VOUCHERS"],function(v){VOUCHERS=v}],["WALLETS",["WALLETS"],function(v){WALLETS=v}]]);_23b‍.w("../functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}],["shuffle_array",["shuffle_array"],function(v){shuffle_array=v}]]);_23b‍.w("./admin",[["paystack_secret_key",["paystack_secret_key"],function(v){paystack_secret_key=v}]]);_23b‍.w("./emails",[["voucher_otp_email",["voucher_otp_email"],function(v){voucher_otp_email=v}],["voucher_purchased_email",["voucher_purchased_email"],function(v){voucher_purchased_email=v}],["voucher_redeemed_email",["voucher_redeemed_email"],function(v){voucher_redeemed_email=v}]]);_23b‍.w("./starter",[["default_wallet",["default_wallet"],function(v){default_wallet=v}]]);_23b‍.w("./users",[["send_mail",["send_mail"],function(v){send_mail=v}]]);_23b‍.w("./utils",[["save_image",["save_image"],function(v){save_image=v}]]);_23b‍.w("./wallets",[["rewards",["rewards"],function(v){rewards=v}]]);
...
const vendor_id = (req, res) => {
  ...
  let user = _23b‍.a("USERS",USERS).readone({ email });
  if (!user)
  ...
  let vendor = _23b‍.a("VENDORS",VENDORS).readone(user.vendor);
...
const create_offer_voucher = (req, res) => {
  ...
  voucher.images = voucher.images.map((img) => {
    img.url = _23b‍.a("save_image",save_image)(img.url);

    return img;
  });
  let result = _23b‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).write(voucher);
  voucher._id = result._id;
  voucher.created = result.created;

  _23b‍.a("VENDORS",VENDORS).update(voucher.vendor, { vouchers: { $inc: 1 } });
...
const offer_vouchers = (req, res) => {
  ...
  res.json({
    ok: true,
    message: "vouchers",
    data: _23b‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).read({ vendor }),
  });
};
...
const open_vouchers = (req, res) => {
  ...
  res.json({
    ok: true,
    message: "vouchers",
    data: _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS).read({ user }),
  });
};
...
const get_offer_vouchers = (req, res) => {
  ...
  let vendors = _23b‍.a("VENDORS",VENDORS).read();
  ...
  _23b‍.a("shuffle_array",shuffle_array)(vouchers);
  ...
  res.json({
    ...
    data: { vendors: n, vouchers, total: _23b‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).config.total_entries },
  });
};
...
const voucher_purchased = (req, res) => {
  ...
  let voucher_code = _23b‍.a("generate_random_string",generate_random_string)(6, "alpha").toUpperCase();
  while (_23b‍.a("PURCHASED_VOUCHERS",PURCHASED_VOUCHERS).readone({ voucher_code }))
    voucher_code = _23b‍.a("generate_random_string",generate_random_string)(6, "alpha").toUpperCase();

  let result = _23b‍.a("PURCHASED_VOUCHERS",PURCHASED_VOUCHERS).write({
    ...details,
    voucher_code,
  });

  let offer_voucher = _23b‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).update(
  ...
  let voucher = _23b‍.a("VOUCHERS",VOUCHERS).write(offer_voucher);
  details.voucher = voucher._id;

  _23b‍.a("USER_VOUCHERS",USER_VOUCHERS).write({
  ...
  _23b‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);

  _23b‍.a("send_mail",send_mail)({
    ...
    html: _23b‍.a("voucher_purchased_email",voucher_purchased_email)({ ...details, voucher_code }),
  });
...
const voucher_creation_fees = (details) => {
  let user = _23b‍.a("USERS",USERS).readone(details.user);
  let fee = user.premium ? 50 : 100;
  _23b‍.a("WALLETS",WALLETS).update(_23b‍.a("default_wallet",default_wallet), {
    total_earning: { $inc: fee },
    balance: { $inc: fee },
  });

  _23b‍.a("TRANSACTIONS",TRANSACTIONS).write({
  ...
  if (user.referral) {
    let ref_fee = fee * 0.1;
    let ref = _23b‍.a("USERS",USERS).readone(user._id);
    _23b‍.a("WALLETS",WALLETS).update(ref.wallet, { balance: { $inc: ref_fee } });
    _23b‍.a("TRANSACTIONS",TRANSACTIONS).write({
      wallet: ref.wallet,
      value: ref_fee,
      type: "voucher",
...
const create_open_voucher = (req, res) => {
  ...
  let result = _23b‍.a("VOUCHERS",VOUCHERS).write(details);
  details._id = result._id;
  details.created = result.created;

  result = _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS).write({
    voucher: details._id,
    user: details.user,
    voucher_code,
  });
...
const user_vouchers = (req, res) => {
  ...
  let open_vouchers = _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS).read({ user }),
    offer_vouchers = _23b‍.a("USER_VOUCHERS",USER_VOUCHERS).read({ user });
...
const can_redeem_voucher = (
  ...
  if (!user && email) {
    user = _23b‍.a("USERS",USERS).readone({ email });
    if (!user)
  ...
  let voucher = (
    voucher_type === "offer_voucher" ? _23b‍.a("USER_VOUCHERS",USER_VOUCHERS) : _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS)
...
const redeem_voucher = (req, res) => {
  ...
  voucher = (
    voucher_type === "open_voucher" ? _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS) : _23b‍.a("USER_VOUCHERS",USER_VOUCHERS)
  ...
  let reference = _23b‍.a("generate_random_string",generate_random_string)(20, "alnum");

  let { _id } = voucher;
  let user_ = _23b‍.a("USERS",USERS).readone(user);
  ...
  if (!email) {
    email = _23b‍.a("USERS",USERS).readone(user);
  ...
  _23b‍.a("axios",axios)({
    ...
    method: "post",
    headers: {
      Authorization: `Bearer ${_23b‍.a("paystack_secret_key",paystack_secret_key)}`,
    ...
    .then((result) => {
      ...
      _23b‍.a("axios",axios)({
        ...
        data: {
          source: "balance",
          amount: value - _23b‍.a("rewards",rewards).voucher_redeemed_fee,
          recipient,
        },
      })
        .then((result) => {
          ...
          if (voucher_type === "open_voucher")
            _23b‍.a("VOUCHERS",VOUCHERS).update(voucher._id, { redeemed: true, state: "redeemed" });

          (voucher_type === "offer_voucher"
            ? _23b‍.a("USER_VOUCHERS",USER_VOUCHERS)
            : _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS)
          ).update({ user, _id }, { state: "redeemed" });

          _23b‍.a("REDEEMED_VOUCHERS",REDEEMED_VOUCHERS).write({
            voucher: voucher._id,
            transfer_details: {
              recipient,
          ...
          let tx = {
            ...
            value: value - _23b‍.a("rewards",rewards).voucher_redeemed_fee,
            wallet: _23b‍.a("USERS",USERS).readone(user).wallet,
          };

          _23b‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);

          let tx_fee = _23b‍.a("rewards",rewards).voucher_redeemed_fee;
          if (referral) {
            referral = _23b‍.a("USERS",USERS).readone(referral);
          ...
          if (referral) {
            let ref_fee = _23b‍.a("rewards",rewards).voucher_redeemed_fee - tx_fee;
            _23b‍.a("WALLETS",WALLETS).update(referral.wallet, {
              balance: { $inc: ref_fee },
          ...
          _23b‍.a("send_mail",send_mail)({
            ...
            html: _23b‍.a("voucher_redeemed_email",voucher_redeemed_email)({ ...details, voucher_code }),
          });
        ...
        .catch((err) => _23b‍.g.console.log(err, "HERE"));
    })
    .catch((err) => _23b‍.g.console.log(err, "H#$#"));
};
...
const request_voucher_otp = (req, res) => {
  ...
  } else if (!email && user) email = _23b‍.a("USERS",USERS).readone(user).email;

  let code = _23b‍.a("generate_random_string",generate_random_string)(6, "num");
  let voucher = (
    voucher_type === "open_voucher" ? _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS) : _23b‍.a("USER_VOUCHERS",USER_VOUCHERS)
  ).readone({ user, voucher_code });
  ...
  let { _id } = voucher;
  let { firstname, lastname } = _23b‍.a("USERS",USERS).readone(user);
  ...
  _23b‍.a("send_mail",send_mail)({
    ...
    html: _23b‍.a("voucher_otp_email",voucher_otp_email)({ ...voucher, code }),
  });
...
const transfer_voucher = (req, res) => {
  ...
  voucher_type === "open_voucher" &&
    _23b‍.a("VOUCHERS",VOUCHERS).update(user_voucher.voucher, { email: email2, user });
...
const verify_voucher = (req, res) => {
  ...
  user = user || _23b‍.a("USERS",USERS).readone({ email: email.toLowerCase() });
  ...
  res.json({
    ...
    data: voucher
      ? {
          ...
          voucher: { ...voucher, user: _23b‍.a("USERS",USERS).readone(voucher.user) },
          _id: voucher._id,
        }
...
const close_voucher = (req, res) => {
  ...
  let result = _23b‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).update(
    { _id: voucher, vendor },
    { state: "closed" }
  );
...
const use_voucher = (req, res) => {
  ...
  voucher = (
    voucher.startsWith("user") ? _23b‍.a("USER_VOUCHERS",USER_VOUCHERS) : _23b‍.a("OPEN_VOUCHERS",OPEN_VOUCHERS)
  ).readone({ _id: voucher, user });

  vendor = _23b‍.a("VENDORS",VENDORS).readone(vendor);
  ...
  _23b‍.a("WALLETS",WALLETS).update(vendor.wallet, { vouchers: { $inc: vendor_value } });
  ...
  _23b‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);
  tx.value = value;
  tx.wallet = _23b‍.a("USERS",USERS).readone(user).wallet;
  tx.credit = false;
  _23b‍.a("TRANSACTIONS",TRANSACTIONS).write(tx);
  ...
  if (voucher.voucher.vendor) {
    _23b‍.a("USER_VOUCHERS",USER_VOUCHERS).update({ user, _id: voucher._id }, { state: "used" });

    _23b‍.a("VOUCHERS",VOUCHERS).update(voucher.voucher._id, { state: "used" });
  } else {
    _23b‍.a("VOUCHERS",VOUCHERS).update(voucher.voucher._id, { value: { $dec: value } });
  }

  res.json({
    ok: true,
    data: { success: true, voucher, vendor, user: _23b‍.a("USERS",USERS).readone(user) },
  });
};
...
const update_voucher = (req, res) => {
  ...
  _23b‍.a("OFFER_VOUCHERS",OFFER_VOUCHERS).update(
...
;_23b‍.j(["get_offer_vouchers","create_offer_voucher","create_open_voucher","offer_vouchers","verify_voucher","open_vouchers","update_voucher","voucher_purchased","user_vouchers","redeem_voucher","can_redeem_voucher","request_voucher_otp","transfer_voucher","close_voucher","parse_vendor_id","reset_vendor_id","use_voucher","vendor_id","generate_voucher_otp","unmask_id","mask_id"]);
